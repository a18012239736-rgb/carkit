...
结果包含 P21 风格竞争力表、配置项判定明细和逐项赋值计算明细，并可导出 Markdown。程序不会按价格自动配对版型。
...
当前内置规则包括续航、高压平台、轮径与轮圈材质、气囊、影像、辅助驾驶、天窗、座椅、音响、车联网和热泵空调等项目。可在“赋值规则”页面直接修改固定金额、动态档位、单位价格和阈值；保存后后续对比立即使用新规则。也可导入/导出 Excel 或恢复内置默认值。
